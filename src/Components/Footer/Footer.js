...
import "./Footer.css";
import footrerLogo from "./owl2.png"
const Footer = () => {
  return (
...
<footer class="bg-white dark:bg-gray-900" style={{backgroundColor:"transparent"}}>
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src={footrerLogo} class="h-8 me-3" alt="FlowBite Logo" />
